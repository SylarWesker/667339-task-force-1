...
class SqlConverter
{
    ...
    /**
     * Метод создания sql кода вставки в БД на основе передаваемых данных.
     *
     * @param $data - массив с данными, которые нужно добавить в БД.
     * @param $relationData - данные для связей с другими таблицами.
     *
